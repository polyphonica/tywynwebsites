  ...
  return (
    <>
      <OfferPageHero
        ...
        description="Bookings, logins, courses, payments and refunds, running on your own site, with no booking-platform commission or subscriptions and no juggling of separate tools. Built on components already running real businesses, so you pay for what's specific to you, not for reinventing the basics. We scope it together in a free, no-obligation video call, so you know the cost before committing, with an ongoing support retainer once it's live."
      />
